...
class AddVacancyPage(BasePage):
    def __init__(self, driver):
        ...
        self.automation_tester = (By.XPATH, "//div[@role='listbox']//div[@role='option']//span[normalize-space()='Automation Tester']")
        ...
        self.automation_tester_vacancies_page = (By.XPATH, "//div[@role='option']//span[normalize-space()='Automation Tester']")
